...
class MortageLoan2 extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final String loanTypeId;
  final LoanApplyController controller;

  const MortageLoan2({super.key, required this.onNext, required this.loanTypeId, required this.controller, required this.onPrevious});

  @override
  State<MortageLoan2> createState() => _MortageLoan2State();
}

class _MortageLoan2State extends State<MortageLoan2> {
  String query = "";
                                              ...
                                              Expanded(
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    ...
                                                    fontFamily: widget.controller.propertyLocation.value == searchList[index].cityCode.toString() ? semiBold : medium,
                                                    fontSize: 12,
                                                  ),
                                                ),
                                              ),
                                            ...
                                            Expanded(
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  fontStyle: FontStyle.normal,
                                                  fontWeight: FontWeight.w400,
                                                  fontFamily: widget.controller.propertyLocation.value == widget.controller.cityList[index].cityCode.toString() ? semiBold : medium,
                                                  fontSize: 12,
                                                ),
                                              ),
                                            ),
