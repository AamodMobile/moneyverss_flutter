...
class MortageLoanEmployment extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final LoanApplyController controller;
  final String loanTypeId;

  const MortageLoanEmployment({Key? key, required this.onNext, required this.onPrevious, required this.controller, required this.loanTypeId}) : super(key: key);

  @override
  State<MortageLoanEmployment> createState() => _MortageLoanEmploymentState();
}

class _MortageLoanEmploymentState extends State<MortageLoanEmployment> {
  @override
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ItemEmployment(
                          ...
                          isBusiness: false,
                          loanTypeId: widget.loanTypeId, isPersonal: false,
                        );
                      },
                    ),
                  ),
