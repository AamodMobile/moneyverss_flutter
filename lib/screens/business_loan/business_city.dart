...
class CurrentBusinessCity extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final String loanTypeId;
  final LoanApplyController controller;

  const CurrentBusinessCity({super.key, required this.onNext, required this.onPrevious, required this.loanTypeId, required this.controller});

  @override
  State<CurrentBusinessCity> createState() => _CurrentBusinessCityState();
}

class _CurrentBusinessCityState extends State<CurrentBusinessCity> {
  String query = "";
                                ...
                                return GridView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, int index) {
                                      return InkWell(
                                        onTap: () {
                                          setState(() {
                                            widget.controller.propertyLocation.value = searchList[index].cityCode.toString();
                                          });
                                        },
                                        child: Container(
                                          height: 54,
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                              color: widget.controller.propertyLocation.value == searchList[index].cityCode.toString() ? primaryClNew : borderNewCl,
                                              width: 1,
                                            ),
                                          ),
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  ...
                                                  style: TextStyle(
                                                    ...
                                                    fontFamily: widget.controller.propertyLocation.value == searchList[index].cityCode.toString().toString() ? semiBold : medium,
                                                    fontSize: 12,
                                                  ),
                                                ),
                                              ),
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: widget.controller.propertyLocation.value == searchList[index].cityCode.toString()
                              ...
                              return GridView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          widget.controller.propertyLocation.value = widget.controller.cityList[index].cityCode.toString();
                                        });
                                      },
                                      child: Container(
                                        height: 54,
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.circular(7),
                                          border: Border.all(
                                            color: widget.controller.propertyLocation.value == widget.controller.cityList[index].cityCode.toString() ? primaryClNew : borderNewCl,
                                            width: 1,
                                          ),
                                        ),
                                        child: Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  fontStyle: FontStyle.normal,
                                                  fontWeight: FontWeight.w400,
                                                  fontFamily: widget.controller.propertyLocation.value == widget.controller.cityList[index].cityCode.toString().toString() ? semiBold : medium,
                                                  fontSize: 12,
                                                ),
                                              ),
                                            ),
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  shape: BoxShape.circle,
                                                  border: widget.controller.propertyLocation.value == widget.controller.cityList[index].cityCode.toString()
                                                      ? Border.all(color: primaryClNew, width: 5)
                                                      : Border.all(color: borderNewCl, width: 1)),
                                            ),
                                          ],
                          ...
                          onTap: () {
                            if (widget.controller.propertyLocation.value == "") {
                              final snackBar = SnackBar(
                                ...
                                content: const Text("Please Select property location"),
