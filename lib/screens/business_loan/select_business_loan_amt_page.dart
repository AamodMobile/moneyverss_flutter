...
class SelectBusinessLoanAmountPage extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final LoanApplyController controller;
  final String loanTypeId;

  const SelectBusinessLoanAmountPage({Key? key, required this.onNext, required this.onPrevious, required this.controller, required this.loanTypeId}) : super(key: key);

  @override
  State<SelectBusinessLoanAmountPage> createState() => _SelectBusinessLoanAmountPageState();
}

class _SelectBusinessLoanAmountPageState extends State<SelectBusinessLoanAmountPage> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: Get.find<LoanApplyController>(),
      initState: (state) => {Get.find<LoanApplyController>().getLoanAmountRangeList(widget.loanTypeId,widget.controller.employmentId.toString())},
      builder: (contextCtrl) {
