...
class NeedSecuredBusinessLoan extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final String loanTypeId;
  final LoanApplyController controller;
  const NeedSecuredBusinessLoan({super.key, required this.onNext, required this.onPrevious, required this.loanTypeId, required this.controller});

  @override
  State<NeedSecuredBusinessLoan> createState() => _NeedSecuredBusinessLoanState();
}

class _NeedSecuredBusinessLoanState extends State<NeedSecuredBusinessLoan> {
