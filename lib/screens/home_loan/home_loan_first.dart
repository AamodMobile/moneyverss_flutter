...
class HomeLoan1 extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onPrevious;
  final String loanTypeId;
  final LoanApplyController controller;

  const HomeLoan1({super.key, required this.onNext, required this.loanTypeId, required this.controller, required this.onPrevious});

  @override
  State<HomeLoan1> createState() => _HomeLoan1State();
}

class _HomeLoan1State extends State<HomeLoan1> {
  @override
