...
class HomeLoan3 extends StatefulWidget {
  ...
  @override
  State<HomeLoan3> createState() => _HomeLoan3State();
}

class _HomeLoan3State extends State<HomeLoan3> {
  @override
                              ...
                              InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    widget.controller.yearRangeName.value = contextCtrl.yearRangeList[index].title.toString();
                                  });
                                },
                                child:  Container(
                                  height: 54,
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            border:
                                            widget.controller.yearRangeId.value == contextCtrl.yearRangeList[index].id.toString()? Border.all(color: primaryClNew, width: 5) : Border.all(color: borderNewCl, width: 1)),
                                      ),
                                    ],
                                  ),
                                ),
